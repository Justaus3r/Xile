...
from rich import print #for beauty like pico
...
import ctypes #for windows to change title(atleast i used it for it)
from distutils.dir_util import copy_tree #for copying dirs i guess
