...
while(True):
    ...
    if command == 'clear' or command == 'cls' or command == 'clr' :
       ...
       if argument == '-f' and os.path.isdir(file) is True:
        ...
        thetable.add_row('troute <host or url>','Trace possible routes and measures transit delay between packets across internet protocol network.Only available for linux.\n_________________________________________________________')
